...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tigercoin-project/tigercoin>";
    const std::string URL_WEBSITE = "<https://tigercoin.org>";
