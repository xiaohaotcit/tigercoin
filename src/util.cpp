...
const char * const BITCOIN_CONF_FILENAME = "tigercoin.conf";
const char * const BITCOIN_PID_FILENAME = "tigercoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tigercoin";
#else
    // Unix
