...
{
    const char* pszTimestamp = "Tiger Tiger 1/11/2021 First Launch";
    const CScript genesisOutputScript = CScript() << ParseHex("112984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1635627256, 2001713172, 0x1e0ffff0, 1, 618 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x78eb8e3deea789ac50d22f2afded52e4c11ecdd7e70b3bd89ee97875132e9779"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ee7ffdcd55e146acb2b28de1a6c31492ec0483d100a740d7de5d46057a7354e"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("50.21.186.239", "tigercoin.online", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("tigercointools.com", "dnsseed.tigercointools.com"));
        //vSeeds.push_back(CDNSSeedData("tigercoinpool.org", "dnsseed.tigercoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x78eb8e3deea789ac50d22f2afded52e4c11ecdd7e70b3bd89ee97875132e9779"))
        ...
        chainTxData = ChainTxData{
            ...
            1635627256, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1635627256, 570238, 0x1e0ffff0, 1, 618 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7522fe2cdfe7c906bf311070dbe1d88b4d318bfd3743b87c07a9330e1c42f8fc"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ee7ffdcd55e146acb2b28de1a6c31492ec0483d100a740d7de5d46057a7354e"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("50.21.186.239", "tigercoin.online"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.tigercoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x7522fe2cdfe7c906bf311070dbe1d88b4d318bfd3743b87c07a9330e1c42f8fc")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1635627256, 0, 0x207fffff, 1, 618 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5b0d1be846cb3c494a9cf2538fb2209a325c856ebe4813799751e6339dde0dff"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ee7ffdcd55e146acb2b28de1a6c31492ec0483d100a740d7de5d46057a7354e"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x5b0d1be846cb3c494a9cf2538fb2209a325c856ebe4813799751e6339dde0dff"))
        };
