...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tigercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tigercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tigercoin transaction") + "\n" +
              "  tigercoin-tx [options] -create [commands]   " + _("Create hex-encoded tigercoin transaction") + "\n" +
              "\n";
